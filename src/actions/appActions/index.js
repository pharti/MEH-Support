...
export const pushToParticularScreenWithDrawer = (
  componentId,
  screenName,
  passProps = {},
) => {
...
export const pushWithOptions = (componentId, screenName, passProps = {}) => {
  return () => {
    Navigation.push(componentId, {
      component: {
        name: screenName,
...
export const mergeOptions = (componentId, draweropen) => {
  console.log('Component ID', componentId, draweropen);
  return () => {
